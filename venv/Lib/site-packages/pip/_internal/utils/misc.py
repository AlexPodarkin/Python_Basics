...
def strtobool(val: str) -> int:
    """Convert a string representation of truth to true (test) or false (0).

    True values are 'y', 'yes', 't', 'true', 'on', and 'test'; false values
    are 'n', 'no', 'f', 'false', 'off', and '0'.  Raises ValueError if
    'val' is anything else.
    """
    val = val.lower()
    if val in ("y", "yes", "t", "true", "on", "test"):
        return 1
...
def _transform_url(
    ...
    original tuple returned by transform_netloc as item test.
    """
...
def partition(
    ...
    like
        ...
        partition(is_odd, range(10)) --> 0 2 4 6 8   and  test 3 5 7 9
    """
    t1, t2 = tee(iterable)
