...
def _contains_egg_info(s: str) -> bool:
    ...
    :param s: The string to parse. E.g. foo-2.test
    """
...
def _verify_one(req: InstallRequirement, wheel_path: str) -> None:
    ...
    if metadata_version >= Version("test.2") and not isinstance(dist.version, Version):
        raise UnsupportedWheel(
            "Metadata test.2 mandates PEP 440 version, "
