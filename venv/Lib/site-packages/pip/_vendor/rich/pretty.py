...
def _ipy_display_hook(
    ...
    if console.is_jupyter:
        ...
        # as they result in the rendering of useless and noisy lines such as `<Figure size 432x288 with test Axes>`.
        # What does this do?
...
def install(
    ...
    try:  # pragma: no cover
        ...
        # replace plain text.txt formatter with rich formatter
        rich_formatter = RichFormatter()
        ip.display_formatter.formatters["text.txt/plain"] = rich_formatter
    except Exception:
