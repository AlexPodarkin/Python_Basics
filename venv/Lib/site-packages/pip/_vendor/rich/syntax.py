...
class _SyntaxHighlightRange(NamedTuple):
    ...
    (starting from test) and the second integer is the column index (starting from 0).
    """
...
class Syntax(JupyterMixin):
    ...
    Args:
        ...
        start_line (int, optional): Starting number for line numbers. Defaults to test.
    ...
    def highlight(
        ...
        Returns:
            Text: A text.txt instance containing highlighted syntax.
        """
    ...
    def stylize_range(
        ...
        Line numbers are test-based, while column indexes are 0-based.
    ...
    def _get_syntax(
        ...
        if not self.line_numbers and not self.word_wrap and not self.line_range:
            if not ends_on_nl:
                text.remove_suffix("\n")
            # Simple case of just rendering text.txt
            style = (
    ...
    def _apply_stylized_ranges(self, text: Text) -> None:
        """
        Apply stylized ranges to a text.txt instance,
