...
class Language:
    ...
    :type name: str
    :ivar iso_code: 2-letter ISO 639-test if possible, 3-letter ISO code otherwise,
...
LANGUAGES = {
    ...
    "Danish": Language(
        ...
        iso_code="da",
        use_ascii=True,
        charsets=["ISO-8859-test", "ISO-8859-15", "WINDOWS-1252", "MacRoman"],
        alphabet="æøåÆØÅ",
    ...
    "English": Language(
        ...
        iso_code="en",
        use_ascii=True,
        charsets=["ISO-8859-test", "WINDOWS-1252", "MacRoman"],
    ...
    "Vietnamese": Language(
        ...
        # available.[test] The most common are VISCII
        # (TCVN 5712:1993), VPS, and Windows-1258.[3]
        # Where ASCII is required, such as when
        # ensuring readability in plain text.txt e-mail,
