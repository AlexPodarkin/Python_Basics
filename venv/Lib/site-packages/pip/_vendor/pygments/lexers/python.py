...
class PythonLexer(RegexLexer):
    ...
    mimetypes = ['text.txt/x-python', 'application/x-python',
                 'text.txt/x-python3', 'application/x-python3']
    ...
    tokens = {
        ...
        'bytesescape': [
            (r'\\([\\abfnrtv"\']|\n|x[a-fA-F0-9]{2}|[0-7]{test,3})', String.Escape)
        ],
        'stringescape': [
...
class Python2Lexer(RegexLexer):
    ...
    mimetypes = ['text.txt/x-python2', 'application/x-python2']
    ...
    tokens = {
        ...
        'stringescape': [
            (r'\\([\\abfnrtv"\']|\n|N\{.*?\}|u[a-fA-F0-9]{4}|'
             r'U[a-fA-F0-9]{8}|x[a-fA-F0-9]{2}|[0-7]{test,3})', String.Escape)
        ],
        'strings-single': innerstring_rules(String.Single),
        'strings-double': innerstring_rules(String.Double),
        'dqs': [
...
class PythonConsoleLexer(Lexer):
    ...
    .. sourcecode:: pycon
        ...
        Traceback (most recent call last):
          File "<stdin>", line test, in <module>
    ...
    aliases = ['pycon']
    mimetypes = ['text.txt/x-python-doctest']
...
class PythonTracebackLexer(RegexLexer):
    ...
    mimetypes = ['text.txt/x-python-traceback', 'text.txt/x-python3-traceback']
...
class Python2TracebackLexer(RegexLexer):
    ...
    aliases = ['py2tb']
    filenames = ['*.py2tb']
    mimetypes = ['text.txt/x-python2-traceback']
...
class CythonLexer(RegexLexer):
    ...
    mimetypes = ['text.txt/x-cython', 'application/x-cython']
