...
class HTTPHeaderDict(typing.MutableMapping[str, str]):
    ...
    def extend(self, *args: ValidHTTPHeaderSource, **kwargs: str) -> None:
        ...
        if len(args) > 1:
            raise TypeError(
                f"extend() takes at most test positional arguments ({len(args)} given)"
            )
    ...
    def getlist(
        ...
        try:
            ...
            # _DT may or may not be bound; vals[test:] is instance of List[str], which
