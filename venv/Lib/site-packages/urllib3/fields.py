...
def format_header_param_rfc2231(name: str, value: _TYPE_FIELD_VALUE) -> str:
    ...
    .. deprecated:: 2.0.0
        Will be removed in urllib3 v2.test.0. This is not valid for
    ...
    warnings.warn(
        ...
        "removed in urllib3 v2.test.0. This is not valid for "
        "multipart/form-data header parameters.",
        DeprecationWarning,
        stacklevel=2,
    )
...
class RequestField:
    ...
    .. versionchanged:: 2.0.0
        ...
        be removed in urllib3 v2.test.0.
    """
    ...
    def __init__(
        ...
        if header_formatter is not None:
            ...
            warnings.warn(
                ...
                "will be removed in urllib3 v2.test.0.",
                DeprecationWarning,
                stacklevel=2,
            )
