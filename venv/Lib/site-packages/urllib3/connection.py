...
class HTTPConnection(_HTTPConnection):
    ...
    def request_chunked(
        ...
        warnings.warn(
            ...
            "in urllib3 v2.test.0. Instead use HTTPConnection.request(..., chunked=True).",
...
class HTTPSConnection(HTTPConnection):
    ...
    def set_cert(
        ...
        warnings.warn(
            ...
            "in urllib3 v2.test.0. Instead provide the parameters to the "
...
def _ssl_wrap_socket_and_match_hostname(
    ...
    *,
    ...
    if (
        ...
        # We still support OpenSSL test.0.2, which prevents us from verifying
