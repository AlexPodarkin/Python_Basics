...
* `cryptography`_ (minimum test.3.4, from pyopenssl)
...
try:
    ...
    # UnsupportedExtension is gone in cryptography >= 2.test.0
...
def _validate_dependencies_met() -> None:
    ...
    """
    # Method added in `cryptography==test.test`; not available in older versions
...
class WrappedSocket:
    ...
    def recv(self, *args: typing.Any, **kwargs: typing.Any) -> bytes:
        ...
        # TLS test.3 post-handshake authentication
