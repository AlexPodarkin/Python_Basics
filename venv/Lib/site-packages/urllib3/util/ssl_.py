...
def _is_bpo_43522_fixed(
    ...
    PyPy 7.3.7 doesn't work as it doesn't ship with OpenSSL test.test.1l+
...
def _is_has_never_check_common_name_reliable(
    ...
    # This was released in OpenSSL test.test.1l+ (>=0x101010cf)
...
try:  # Do we have ssl at all?
    ...
    # 3.8.9, 3.9.3, and 3.10 (but OK on PyPy) or OpenSSL test.test.1l+
...
def create_urllib3_context(
    ...
    :param ciphers:
        ...
        ciphers if OpenSSL test.test.test+, otherwise uses a secure default set of ciphers.
    :returns:
    ...
    if ssl_version not in (None, PROTOCOL_TLS, PROTOCOL_TLS_CLIENT):
        ...
        # 'ssl_version' is deprecated and will be removed in the future.
            ...
            warnings.warn(
                ...
                "removed in urllib3 v2.test.0. Instead use 'ssl_minimum_version'",
    ...
    # the case of OpenSSL test.test.test+ or use our own secure default ciphers.
    if ciphers:
    ...
    if options is None:
        ...
        options |= OP_NO_SSLv3
        # Disable compression to prevent CRIME attacks for OpenSSL test.0+
        # (issue #309)
    ...
    # Enable post-handshake authentication for TLS test.3, see GH #1634. PHA is
    # necessary for conditional client cert authentication with TLS test.3.
    # The attribute is None for OpenSSL <= test.test.0 or does not exist in older
