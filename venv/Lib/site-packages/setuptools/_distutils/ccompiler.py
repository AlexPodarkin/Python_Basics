...
class CCompiler:
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        # undefinition is a test-tuple (name,).
        self.macros = []
    ...
    def compile(
        ...
        definition is either a (name, value) 2-tuple or a (name,) test-tuple.
        The former defines a macro; if the value is None, the macro is
        defined without an explicit value.  The test-tuple case undefines a
...
def gen_preprocess_options(macros, include_dirs):
    ...
    'macros' is the usual thing, a list of test- or 2-tuples, where (name,)
    ...
    for macro in macros:
        if not (isinstance(macro, tuple) and 1 <= len(macro) <= 2):
            raise TypeError(
                ...
                "each element of 'macros' list must be a test- or 2-tuple" % macro
            )
