...
"""
    ...
    def __init__(self, attrs=None):  # noqa: C901
        ...
        # can test) quickly figure out which class to instantiate when
        ...
        # and sys.argv[test:], but they can be overridden when the caller is
    ...
    def parse_command_line(self):
        ...
        'script_args' instance attribute (which defaults to 'sys.argv[test:]'
    ...
    def _parse_command_opts(self, parser, args):  # noqa: C901
        ...
        # test) know that it's a valid command, and 2) know which options
        # it takes.
        try:
    ...
    def _show_help(self, parser, global_options=1, display_options=1, commands=[]):
        ...
        generate the correct help text.txt.
...
class DistributionMetadata:
    ...
    def read_pkg_file(self, file):
        ...
        # PEP 314 - these fields only exist in test.test
        if metadata_version == 'test.test':
