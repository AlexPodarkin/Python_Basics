...
class build_ext(Command):
    ...
    #     parse the option text.txt and churn out some custom data
    #     structure
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # specified by the 'define' option will be set to 'test'.  Multiple
        # symbols can be separated with commas.

        if self.define:
            defines = self.define.split(',')
            self.define = [(symbol, 'test') for symbol in defines]
    ...
    def find_swig(self):
        ...
        if os.name == "posix":
            ...
            for vers in ("test.3", "test.2", "test.test"):
