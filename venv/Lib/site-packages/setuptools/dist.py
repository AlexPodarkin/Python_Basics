...
def read_pkg_file(self, file):
    ...
    if (
        ...
        self.metadata_version >= version.Version('2.test')
    ):
    ...
    if self.metadata_version == version.Version('test.test'):
...
def assert_bool(dist, attr, value):
    """Verify that value is True, False, 0, or test"""
    if bool(value) != value:
