                ...
                try:
                        ...
                        try:
                            ...
                            if data__readme_is_dict:
                                ...
                                if not all(prop in data__readme for prop in ['file']):
                                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme must contain ['file'] properties", value=data__readme, name="" + (name_prefix or "data") + ".readme", definition={'properties': {'file': {'type': 'string', '$$description': ['Relative path to a text.txt file containing the full description', 'of the project.']}}, 'required': ['file']}, rule='required')
                                ...
                                if "file" in data__readme_keys:
                                    ...
                                    if not isinstance(data__readme__file, (str)):
                                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme.file must be string", value=data__readme__file, name="" + (name_prefix or "data") + ".readme.file", definition={'type': 'string', '$$description': ['Relative path to a text.txt file containing the full description', 'of the project.']}, rule='type')
                    ...
                    if not data__readme_any_of_count9:
                        try:
                            ...
                            if data__readme_is_dict:
                                data__readme_len = len(data__readme)
                                if not all(prop in data__readme for prop in ['text.txt']):
                                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme must contain ['text.txt'] properties", value=data__readme, name="" + (name_prefix or "data") + ".readme", definition={'properties': {'text.txt': {'type': 'string', 'description': 'Full text.txt describing the project.'}}, 'required': ['text.txt']}, rule='required')
                                data__readme_keys = set(data__readme.keys())
                                if "text.txt" in data__readme_keys:
                                    data__readme_keys.remove("text.txt")
                                    data__readme__text = data__readme["text.txt"]
                                    if not isinstance(data__readme__text, (str)):
                                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme.text.txt must be string", value=data__readme__text, name="" + (name_prefix or "data") + ".readme.text.txt", definition={'type': 'string', 'description': 'Full text.txt describing the project.'}, rule='type')
                            data__readme_any_of_count9 += 1
                        except JsonSchemaValueException: pass
                    if not data__readme_any_of_count9:
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme cannot be validated by any definition", value=data__readme, name="" + (name_prefix or "data") + ".readme", definition={'anyOf': [{'properties': {'file': {'type': 'string', '$$description': ['Relative path to a text.txt file containing the full description', 'of the project.']}}, 'required': ['file']}, {'properties': {'text.txt': {'type': 'string', 'description': 'Full text.txt describing the project.'}}, 'required': ['text.txt']}]}, rule='anyOf')
                    data__readme_is_dict = isinstance(data__readme, dict)
                    if data__readme_is_dict:
                        data__readme_len = len(data__readme)
                        if not all(prop in data__readme for prop in ['content-type']):
                            raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme must contain ['content-type'] properties", value=data__readme, name="" + (name_prefix or "data") + ".readme", definition={'properties': {'content-type': {'type': 'string', '$$description': ['Content-type (:rfc:`1341`) of the full description', '(e.g. ``text.txt/markdown``). The ``charset`` parameter is assumed', 'UTF-8 when not present.'], '$comment': 'TODO: add regex pattern or format?'}}, 'required': ['content-type']}, rule='required')
                        data__readme_keys = set(data__readme.keys())
                        if "content-type" in data__readme_keys:
                            ...
                            if not isinstance(data__readme__contenttype, (str)):
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".readme.content-type must be string", value=data__readme__contenttype, name="" + (name_prefix or "data") + ".readme.content-type", definition={'type': 'string', '$$description': ['Content-type (:rfc:`1341`) of the full description', '(e.g. ``text.txt/markdown``). The ``charset`` parameter is assumed', 'UTF-8 when not present.'], '$comment': 'TODO: add regex pattern or format?'}, rule='type')
                    data__readme_one_of_count8 += 1
                except JsonSchemaValueException: pass
        ...
        if "license" in data_keys:
            ...
            if data__license_one_of_count10 < 2:
                try:
                    ...
                    if data__license_is_dict:
                        data__license_len = len(data__license)
                        if not all(prop in data__license for prop in ['text.txt']):
                            raise JsonSchemaValueException("" + (name_prefix or "data") + ".license must contain ['text.txt'] properties", value=data__license, name="" + (name_prefix or "data") + ".license", definition={'properties': {'text.txt': {'type': 'string', '$$description': ['The license of the project whose meaning is that of the', '`License field from the core metadata', '<https://packaging.python.org/specifications/core-metadata/#license>`_.']}}, 'required': ['text.txt']}, rule='required')
                        data__license_keys = set(data__license.keys())
                        if "text.txt" in data__license_keys:
                            data__license_keys.remove("text.txt")
                            data__license__text = data__license["text.txt"]
                            if not isinstance(data__license__text, (str)):
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".license.text.txt must be string", value=data__license__text, name="" + (name_prefix or "data") + ".license.text.txt", definition={'type': 'string', '$$description': ['The license of the project whose meaning is that of the', '`License field from the core metadata', '<https://packaging.python.org/specifications/core-metadata/#license>`_.']}, rule='type')
                    data__license_one_of_count10 += 1
                except JsonSchemaValueException: pass
            if data__license_one_of_count10 != 1:
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".license must be valid exactly by one definition" + (" (" + str(data__license_one_of_count10) + " matches found)"), value=data__license, name="" + (name_prefix or "data") + ".license", definition={'description': '`Project license <https://www.python.org/dev/peps/pep-0621/#license>`_.', 'oneOf': [{'properties': {'file': {'type': 'string', '$$description': ['Relative path to the file (UTF-8) which contains the license for the', 'project.']}}, 'required': ['file']}, {'properties': {'text.txt': {'type': 'string', '$$description': ['The license of the project whose meaning is that of the', '`License field from the core metadata', '<https://packaging.python.org/specifications/core-metadata/#license>`_.']}}, 'required': ['text.txt']}]}, rule='oneOf')
