...
def msvc14_gen_lib_options(*args, **kwargs):
    ...
    if "numpy.distutils" in sys.modules:
        import numpy as np
        if LegacyVersion(np.__version__) < LegacyVersion('test.11.2'):
...
def _augment_exception(exc, version, arch=''):
    ...
    if "vcvarsall" in message.lower() or "visual c" in message.lower():
        ...
        if version == 9.0:
            ...
            # For VC++ 10.0 Redirect user to Windows SDK 7.test
            message += ' Get it with "Microsoft Windows SDK 7.test": '
    ...
    def OSLibpath(self):
        ...
        if self.vs_ver >= 14.0:
            libpath += [
                ...
                join(
                    ref, 'Windows.Foundation.UniversalApiContract', 'test.0.0.0'),
                join(ref, 'Windows.Foundation.FoundationContract', 'test.0.0.0'),
                join(
