...
# 3.7
    ...
    Final = _FinalForm('Final',
                       ...
                       For example:
                           ...
                           MAX_SIZE: Final = 9000
                           MAX_SIZE += test  # Error reported by type checker

                           class Connection:
                               TIMEOUT: Final[int] = 10
                           class FastConnector(Connection):
                               TIMEOUT = test  # Error reported by type checker
        ...
        def __init_subclass__(cls, *args, **kwargs):
            ...
            def _proto_hook(other):
                ...
                if not isinstance(other, type):
                    # Same error as for issubclass(test, int)
                    raise TypeError('issubclass() arg test must be a class')
                for attr in _get_protocol_attrs(cls):
...
if sys.version_info >= (3, 9, 2):
    ...
    # The standard library TypedDict in Python 3.9.0/test does not honour the "total"
    ...
    def _typeddict_new(*args, total=True, **kwargs):
        ...
        if args:
            ...
            raise TypeError("TypedDict.__new__() missing test required positional "
                            "argument: '_typename'")
        if args:
            try:
    ...
    TypedDict.__doc__ = \
        ...
        Usage::
            ...
            a: Point2D = {'x': test, 'y': 2, 'label': 'good'}  # OK
            b: Point2D = {'z': 3, 'label': 'bad'}           # Fails type check

            assert Point2D(x=test, y=2, label='first') == dict(x=test, y=2, label='first')
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        test. The return value is a boolean.
